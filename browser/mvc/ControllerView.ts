...
//missing
import {IRetrievable} from "browser/mvc/IRetrievable";
//missing
import {View} from "browser/mvc/View";
//convert
 /* ghost.browser.mvc.Application.*/
import {Application} from "browser/mvc/Application";
//convert
 /*:ghost.browser.navigation.NavigationScope
*/
import {NavigationScope} from "browser/navigation/NavigationScope";
//convert
...
//                            console.log("ALL MODEL DONE");
        ...
        public getScope():NavigationScope
        {
            return Navigation.instance.getScope(this.scoping());
        }
        /**
