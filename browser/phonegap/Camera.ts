...
import {Root} from "ghost/core/Root";
    ...
    export class _CameraManager
    {
        ...
        constructor()
        {
            this._camera = Root.getRoot().navigator["camera"];
        }
        /**
     ...
     * @type Camera
     */
    export var CameraManager:_CameraManager = Hardware.isBrowser()?new _CameraManager():null;
