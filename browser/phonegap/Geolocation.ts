...
import {Root} from "ghost/core/Root";
     ...
     */
    export class GeolocationWatcher extends EventDispatcher
    {
        /**
    ...
    export class _Geolocation
    {
        ...
        constructor()
        {
            this._geolocation = Root.getRoot().navigator["geolocation"];
        }
        /**
     ...
     * @type _Geolocation
     */
    export var Geolocation:_Geolocation = Hardware.isBrowser()?new _Geolocation():null;
