...
import {Root} from "ghost/core/Root";
     ...
     * @private
     */
    export class _Notification/* extends EventDispatcher*/
    {
        ...
        {
            //super();
            this._notifier = Root.getRoot().navigator["notification"];
        }
        /**
     ...
     * @type Notification
     */
    export var Notification:_Notification = Hardware.isBrowser()?new _Notification():null;
