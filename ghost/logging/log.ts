	...
	export class log
	{
		...
		*/
        ...
        private static _getDisplayDate():string
        {
			...
			display += Maths.toMinNumber(date.getHours(), 2) + ":";
			display += Maths.toMinNumber(date.getMinutes(), 2) + ":";
			display += Maths.toMinNumber(date.getSeconds(), 2) + ".";
			display += Maths.toMinNumber(date.getMilliseconds(), 3);
